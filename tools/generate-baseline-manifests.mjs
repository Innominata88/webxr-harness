...
function buildManifest(def) {
  ...
  return {
    ...
    source: {
      ...
      profilerConfig: baseValues.profilerConfig,
      xrIdlePresentMode: baseValues.xrIdlePresentMode,
      xrPoseStabilityGateMs: baseValues.xrPoseStabilityGateMs,
      xrPoseStabilityPosTolM: baseValues.xrPoseStabilityPosTolM,
      xrPoseStabilityYawTolDeg: baseValues.xrPoseStabilityYawTolDeg,
