...
const ENV_FAIRNESS_FIELDS = [
  ...
  { name: "xr_pose_stability_gate_ms_requested" },
  { name: "xr_pose_stability_pos_tol_m_requested", tol: 1e-9 },
  { name: "xr_pose_stability_yaw_tol_deg_requested", tol: 1e-9 },
